...
static void mavlink_test_fc_values(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FC_VALUES >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fc_values_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,221,"VWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTU"
    };
    mavlink_fc_values_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        ...
        packet1.ld_voltage = packet_in.ld_voltage;
        packet1.temp_sensor_1_celc = packet_in.temp_sensor_1_celc;
        packet1.temp_sensor_2_celc = packet_in.temp_sensor_2_celc;
        packet1.temp_sensor_3_celc = packet_in.temp_sensor_3_celc;
        packet1.temp_sensor_4_celc = packet_in.temp_sensor_4_celc;
        packet1.tst_temperature_celc = packet_in.tst_temperature_celc;
        packet1.pcb_temperature = packet_in.pcb_temperature;
        packet1.side_h2_pressure = packet_in.side_h2_pressure;
        packet1.mvprs = packet_in.mvprs;
        packet1.fan_speed = packet_in.fan_speed;
        packet1.operation_status = packet_in.operation_status;
        
        mav_array_memcpy(packet1.message, packet_in.message, sizeof(char)*131);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FC_VALUES_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FC_VALUES_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fc_values_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fc_values_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fc_values_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.stack_voltage , packet1.load_current , packet1.power , packet1.energy , packet1.bat_voltage , packet1.bat_current , packet1.ld_voltage , packet1.temp_sensor_1_celc , packet1.temp_sensor_2_celc , packet1.temp_sensor_3_celc , packet1.temp_sensor_4_celc , packet1.tst_temperature_celc , packet1.pcb_temperature , packet1.side_h2_pressure , packet1.mvprs , packet1.operation_status , packet1.fan_speed , packet1.message );
    mavlink_msg_fc_values_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fc_values_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.stack_voltage , packet1.load_current , packet1.power , packet1.energy , packet1.bat_voltage , packet1.bat_current , packet1.ld_voltage , packet1.temp_sensor_1_celc , packet1.temp_sensor_2_celc , packet1.temp_sensor_3_celc , packet1.temp_sensor_4_celc , packet1.tst_temperature_celc , packet1.pcb_temperature , packet1.side_h2_pressure , packet1.mvprs , packet1.operation_status , packet1.fan_speed , packet1.message );
    mavlink_msg_fc_values_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fc_values_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fc_values_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.stack_voltage , packet1.load_current , packet1.power , packet1.energy , packet1.bat_voltage , packet1.bat_current , packet1.ld_voltage , packet1.temp_sensor_1_celc , packet1.temp_sensor_2_celc , packet1.temp_sensor_3_celc , packet1.temp_sensor_4_celc , packet1.tst_temperature_celc , packet1.pcb_temperature , packet1.side_h2_pressure , packet1.mvprs , packet1.operation_status , packet1.fan_speed , packet1.message );
    mavlink_msg_fc_values_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_fc_values(system_id, component_id, last_msg);
}
